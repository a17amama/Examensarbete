      ...
      <!--Menu, with dropdowns and images in menu-->
        ...
        <div class="navigation-box">
          ...
          <div class="content-box">          
             <table>
                <tr>
                    <td><a href="accessholder.php"><img class="menu-images" src="glasses.svg"></a></td>
                    <td><a href="accessholder.php"><img class="menu-images" src="necklace.svg"></a></td>
                    <td><a href="accessholder.php"><img class="menu-images" src="hat.svg"></a></td>
                    <td><a href="imgIndBag.php"><img class="menu-images" src="purse.svg"></a></td>
