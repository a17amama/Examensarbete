      ...
      <!--Menu, with dropdowns and images in menu-->
        ...
        <div class="navigation-box">
          ...
          <div class="content-box">          
             <table>
                <tr>
                    <td><a href="pantholder.php"><img class="menu-images" src="bottoms.svg"></a></td>
                    <td><a href="pantholder.php"><img class="menu-images" src="shorts.svg"></a></td>
                    <td><a href="imgIndSkirt.php"><img class="menu-images" src="skirt.svg"></a></td>
