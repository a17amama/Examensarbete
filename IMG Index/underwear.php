      ...
      <!--Menu, with dropdowns and images in menu-->
        ...
        <div class="navigation-box">
          ...
          <div class="content-box">          
             <table>
                <tr>
                    <td><a class="log" href="underwearholder.php"><img class="menu-images" src="lingerie.svg"></a></td>
                    <td><a class="log" href="underwearholder.php"><img class="menu-images" src="bras.svg"></a></td>
                    <td><a class="log" href="underwearholder.php"><img class="menu-images" src="boxers.svg"></a></td>
