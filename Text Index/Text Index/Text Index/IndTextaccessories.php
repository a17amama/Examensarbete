      ...
      <!--Menu, with dropdowns and images in menu-->
        ...
        <div class="navigation-box">
          ...
          <div class="content-box">          
             <table>
                <tr>
                    <td class="textmenu"><a href="IndTextglasses.php">Glasses</a></td>    
                      <td class="textmenu"><a href="IndTextaccessories.php">Necklace</a></td>    
                      <td class="textmenu"><a href="IndTexthat.php">Hats</a></td>    
                      <td class="textmenu"><a href="IndTextbags.php">Bags</a></td>    
                  </tr>
