      ...
      <!--Menu, with dropdowns and images in menu-->
        ...
        <div class="navigation-box">
          ...
          <div class="content-box">          
             <table>               
                <tr>
                  <td class="menuitem"><a class="menuitem" href="IndTextshoesHolder.php">Sneakers</a></td>    
                    <td class="menuitem"><a class="menuitem" href="IndTextheels.php">Heels</a></td>    
                    <td class="menuitem"><a class="menuitem" href="IndTextshoesHolder.php">Sandals</a></td>    
                </tr>
