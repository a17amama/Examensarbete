      ...
      <!--Menu, with dropdowns and images in menu-->
        ...
        <div class="navigation-box">
          ...
          <div class="content-box">          
             <table>
                <tr>
                    <td class="menuitem"><a class="menuitem log"  href="IndTextdresses.php">Dress</a></td>       
                      <td class="menuitem"><a class="menuitem log" href="IndTextdressHolder.php">Overall</a></td>    
                  </tr>
