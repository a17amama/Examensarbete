      ...
      <!--Menu, with dropdowns and images in menu-->
        ...
        <div class="navigation-box">
          ...
          <div class="content-box">          
             <table>               
                <tr>
                  <td class="menuitem"><a class="menuitem log" href="IndTextswimwearHolder.php">Bikini</a></td>    
                    <td class="menuitem"><a class="menuitem log" href="IndTextswimwearHolder.php">Swimshorts</a></td>    
                    <td class="menuitem"><a  class="menuitem log" href="IndTextswimwearHolder.php">Swimsuit</a></td>    
                </tr>
